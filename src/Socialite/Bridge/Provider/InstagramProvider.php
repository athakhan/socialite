...
class InstagramProvider extends BaseProvider {
    protected $oauth_access_token_url  = 'https://api.instagram.com/oauth/access_token';
    protected $oauth_authorize_url     = 'https://api.instagram.com/oauth/authorize/?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}';
