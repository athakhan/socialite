...
class GoogleProvider extends BaseProvider {
    ...
    protected $oauth_authorize_url     = 'https://accounts.google.com/o/oauth2/auth?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
