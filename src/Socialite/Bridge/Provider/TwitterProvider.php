...
class TwitterProvider extends BaseProvider {
    ...
    protected $oauth_access_token_url  = 'https://api.twitter.com/oauth/access_token';
    protected $oauth_authenticate_url  = 'https://api.twitter.com/oauth/authenticate';
    protected $oauth_authorize_url     = 'https://api.twitter.com/oauth/authorize';
