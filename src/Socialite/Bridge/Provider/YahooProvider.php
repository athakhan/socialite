...
class YahooProvider extends BaseProvider {
    protected $oauth_request_token_url = 'https://api.login.yahoo.com/oauth/v2/get_request_token';
    protected $oauth_access_token_url  = 'https://api.login.yahoo.com/oauth/v2/get_token';
    protected $oauth_authorize_url     = 'https://api.login.yahoo.com/oauth/v2/request_auth';
