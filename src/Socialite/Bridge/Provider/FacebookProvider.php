...
class FacebookProvider extends BaseProvider {
    protected $oauth_access_token_url  = 'https://graph.facebook.com/oauth/access_token';
    protected $oauth_authorize_url     = 'http://www.facebook.com/dialog/oauth?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
